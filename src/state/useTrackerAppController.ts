...
export function useTrackerAppController({ selectedBabyId = '' }: { selectedBabyId?: string | null } = {}) {
  ...
  const { gotifyAvailable, gotifyRemindersEnabled, medicineReminderSettings, notificationPermission, notificationPreferences, setGotifyReminders, setMedicineReminderSettings, setNotificationPreferences, enableFeedingNotifications } = useNotificationSettings({ setFeedingNotificationsEnabled, showToast })
  ...
  const modalsProps: TrackerModalsProps = { bottleOpen, manualOpen, pastEventOpen, settingsOpen, session, bottleQuickOz, manualDraft, pastEventDraft, entries, diapers, babyDob, tummyGoalMinutes, feedingNotificationsEnabled, browserRemindersEnabled, notificationPermission, notificationPreferences, gotifyAvailable, gotifyRemindersEnabled, medicineReminderSettings, theme, fileInputRef, setBottleOpen, setManualOpen, setPastEventOpen, setSettingsOpen, setBottleQuickOz, setManualDraft, setPastEventDraft, setEntries, setDiapers, setBabyDob, setTummyGoalMinutes, setSession, setUndoState, setFeedingNotificationsEnabled, setBrowserRemindersEnabled, setNotificationPreferences, setTheme, logBottle, saveManualFeed, savePastEvent, enableFeedingNotifications, setGotifyReminders, setMedicineReminderSettings, showToast }
