...
export function TummyTimeReminderBanner({ reminder, startTummyTime }: Props) {
  ...
  return (
    <div className="medicine-reminder-stack" aria-label="Tummy Time reminder">
      <div className="medicine-reminder-banner tummy-reminder-banner" role="status">
        ...
        <button type="button" className="medicine-reminder-action" aria-label="Start Tummy Time from reminder" onClick={startTummyTime}><Dumbbell size={14} /> Start Tummy Time</button>
      </div>
    </div>
  )
}
